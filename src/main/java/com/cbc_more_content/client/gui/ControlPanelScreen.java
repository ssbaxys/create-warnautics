...
public class ControlPanelScreen extends Screen {
    ...
    private void renderSwitch(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        float eased = Mth.approach(this.slide, this.cannonFx ? 1.0f : 0.0f,
                partialTick / THROW_TICKS);
        ...
        graphics.fill(knobX + 1, knobY + 1, knobX + KNOB_W - 1, knobY + knobH - 1,
                hot ? 0xFF6A7060 : 0xFF55594C);
        ...
        graphics.drawCenteredString(this.font,
                Component.translatable(this.cannonFx
                        ? "gui.cbc_more_content.panel.on"
                        : "gui.cbc_more_content.panel.off"),
                knobX + KNOB_W / 2, knobY + knobH / 2 - 4,
