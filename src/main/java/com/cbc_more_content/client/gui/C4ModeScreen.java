...
public class C4ModeScreen extends Screen {
    ...
    private void renderOption(
        ...
        graphics.drawString(
                this.font, Component.translatable(title), x + 8, y + 4, chosen ? 0xFFB036 : 0xE8E2CF, false);
        drawFitted(graphics, Component.translatable(description).getString(), x + 8, y + 15, OPTION_W - 16, 0x9AA08C);
    }
    ...
    private void renderConfirm(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawCenteredString(
                this.font,
                Component.translatable(this.remote ? "gui.cbc_more_content.c4.arm" : "gui.cbc_more_content.c4.next"),
                x + BUTTON_W / 2,
                y + 5,
    ...
    private void confirm() {
        ...
        PacketDistributor.sendToServer(new ConfigureC4Payload(this.pos, this.fuseSeconds(), true, true));
        this.onClose();
    }
    ...
    private int fuseSeconds() {
        ...
        if (mc.level != null
                && mc.level.getBlockEntity(this.pos) instanceof com.cbc_more_content.block.C4BlockEntity charge) {
