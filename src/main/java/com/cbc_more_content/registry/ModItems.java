...
public final class ModItems {
     ...
     */
    public static final DeferredItem<Item> MUSIC_DISC_BREAKER_OF_SKIES =
            ITEMS.register("music_disc_breaker_of_skies", () -> new Item(new Item.Properties()
                    .stacksTo(1)
    ...
    public static final DeferredItem<C4Item> C4 = ITEMS.register("c4",
            () -> new C4Item(new Item.Properties().stacksTo(1)));
