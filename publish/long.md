![Create Warnautics](create_warnautics_curseforge_banner_transparent.png)

**Create Warnautics** expands [Create Big Cannons](https://www.curseforge.com/minecraft/mc-mods/create-big-cannons) with placeable aerial ordnance built for Create machines, moving vehicles, bombing runs, and destructive multiplayer battles.
...
Effect and sound budgets reduce duplicate particles, lights, and audio during large bombing runs. Optional [Veil](https://www.curseforge.com/minecraft/mc-mods/veil) support enhances dynamic lights and bloom; the core explosion effects still work without it.

## Sable and vehicle compatibility

[Sable](https://modrinth.com/mod/sable) is optional.
...
- **Java:** 21
- **Required:** [Create 6.0.10](https://www.curseforge.com/minecraft/mc-mods/create) or newer within the 6.0.x line
- **Required:** [Create Big Cannons 5.11.x](https://www.curseforge.com/minecraft/mc-mods/create-big-cannons)
- **Required by CBC:** [Ritchie's Projectile Library 2.1.2](https://www.curseforge.com/minecraft/mc-mods/ritchies-projectile-library)
